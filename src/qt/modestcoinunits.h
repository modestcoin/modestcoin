...
#ifndef MODESTCOIN_QT_MODESTCOINUNITS_H
#define MODESTCOIN_QT_MODESTCOINUNITS_H
...
/** Modestcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ModestcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ModestcoinUnits(QObject *parent);

    /** Modestcoin units.
      @note Source: https://en.modestcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef ModestcoinUnits::Unit ModestcoinUnit;

#endif // MODESTCOIN_QT_MODESTCOINUNITS_H
