...
void RPCConsole::clear(bool clearHistory)
{
    ...
    ui->messagesWidget->document()->setDefaultStyleSheet(
        QString(
                "table { }"
                "td.time { font-family: calibri Lt, sans-recif; font-size: 12px; color: #808080; padding-top: 3px; } "
                "td.message { font-family: calibri, sans-recif; font-weight: normal; font-size: 13px; color: #2A2A2A; white-space:pre-wrap; } "
                "td.cmd-request { color: #808080; font-size: 12px; font-family: calibri Lt, sans-recif; } "
                "td.cmd-error { color: #6D00F3; font-family: calibri Lt, sans-recif; font-size: 12px; } "
                ".secwarning { color: #6D00F3; font-family: calibri Lt, sans-recif; font-size: 12px; }"
                "b { color: #00A8F3; font-family: calibri, sans-recif; font-size: 13px; } "
    ...
    message(CMD_REPLY, (tr("%1 to clear screen.").arg("<b>"+clsKey+"</b>") + "<br>" +
                        tr("%1 for all commands.").arg("<b>help</b>") + "<br>" +
                        "</span>"),
                        true);
}
