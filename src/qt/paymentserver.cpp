...
const QString BITCOIN_IPC_PREFIX("modestcoin:");
#ifdef ENABLE_BIP70
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("modestcoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'modestcoin://' is not a valid URI. Use 'modestcoin:' instead."),
