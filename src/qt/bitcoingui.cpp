    ...
    m_network_style(networkStyle)
{
    ...
    // See https://qt-project.org/doc/qt-4.8/gallery.html
        progressBar->setStyleSheet("QProgressBar { background-color: #1F2228; font-size: 10px; font-family: Diversa Sans Com Black, sans-recif; font-weight: normal; max-height: 10px; color: #F3F3F3; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #1F2228, stop: 1 #31B1F4); border-radius: 7px; margin: 0px; max-height: 10px;  }");
...
void BitcoinGUI::createActions()
{
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Modestcoin command-line options").arg(PACKAGE_NAME));
