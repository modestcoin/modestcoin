...
#if defined(NDEBUG)
# error "Modestcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Modestcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("modestcoin-scriptch");
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // Modestcoin: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.
