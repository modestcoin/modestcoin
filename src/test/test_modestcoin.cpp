...
#define BOOST_TEST_MODULE Modestcoin Test Suite

#include "test_modestcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_modestcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
