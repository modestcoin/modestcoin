...
# Copyright 2016 The Modestcoin Core developers
...
help_text="""Test framework for modestcoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/modestcoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "modestcoin-util-test.json", buildenv)
