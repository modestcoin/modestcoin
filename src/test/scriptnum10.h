...
#ifndef MODESTCOIN_TEST_SCRIPTNUM10_H
#define MODESTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Modestcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MODESTCOIN_TEST_BIGNUM_H
