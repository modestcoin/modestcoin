...
#ifndef MODESTCOIN_WALLET_WALLET_H
#define MODESTCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this modestcoin node, and set to 0 for transactions that were created
...
#endif // MODESTCOIN_WALLET_WALLET_H
