...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " modestcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  modestcoin-tx [options] <hex-tx> [commands]  Update hex-encoded modestcoin transaction\n" +
            "or:     modestcoin-tx [options] -create [commands]   Create hex-encoded modestcoin transaction\n" +
            "\n";
