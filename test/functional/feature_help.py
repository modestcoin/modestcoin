...
"""Verify that starting modestcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start modestcoin with -h for help text")
        ...
        self.log.info("Start modestcoin with -version for version information")
        ...
        self.log.info("Start modestcoind with -fakearg to make sure it does not start")
