...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/modestcoin/modestcoin/blob/master/doc/translation_process.md#synchronising-translations).
...
* Update hardcoded [seeds](/contrib/seeds/README.md), see [this pull request](https://github.com/modestcoin/modestcoin/pull/7415) for an example.
...
### Modestcoin maintainers/release engineers, update version in sources
...
### Fetch and create inputs: (first time, or when dependency versions change)
    ...
    pushd ./gitian-builder
    mkdir -p inputs
    wget -P inputs https://modestcoincore.org/cfields/osslsigncode-Backports-to-1.7.1.patch
...
### Build and sign Modestcoin Core for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit modestcoin=v${VERSION} ../modestcoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit modestcoin=v${VERSION} ../modestcoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit modestcoin=v${VERSION} ../modestcoin/contrib/gitian-descriptors/gitian-osx.yml
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the modestcoin.org server.
