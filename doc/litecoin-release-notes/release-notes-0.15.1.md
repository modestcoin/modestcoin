Modestcoin Core version *0.15.1* is now available from:

  <https://download.modestcoin.org/modestcoin-0.15.1/>
...
A number of changes to the way Modestcoin Core deals with peer connections and invalid blocks
