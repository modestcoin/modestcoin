Modestcoin Core version 0.10.4 is now available from:

  <https://modestcoin.org/bin/modestcoin-core-0.10.4/>
...
- #6953 `43c2789` Split modestcoin-tx into its own package
- #6953 `dfe0d4d` Include modestcoin-tx binary on Debian/Ubuntu
