Modestcoin Core version 0.9.4 is now available from:

  https://modestcoin.org/bin/0.9.4/
...
this update is incompatible with the Modestcoin system and could lead to consensus
forks.

Modestcoin Core released binaries from https://modestcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~modestcoin/+archive/ubuntu/modestcoin
- A third-party or self-compiled Modestcoin Core

upgrade to Modestcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
