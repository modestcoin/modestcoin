Modestcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/modestcoin/files/Modestcoin/modestcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Modestcoin
...
New/changed settings (command-line or modestcoin.conf file)
--------------------------------------------------------
