Modestcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/modestcoin/files/Modestcoin/modestcoin-0.5.4/
...
http://gitorious.org/modestcoin/modestcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Modestcoin-Qt notifications under Growl 1.3.
Increase required age of Modestcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxModestcoin properly when installing Modestcoin-Qt over it. (Windows)
