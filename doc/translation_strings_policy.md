...
This document provides guidelines for internationalization of the Modestcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `modestcoin_en.ts` remains unchanged.
