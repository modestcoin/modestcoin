...
class RawTransactionsTest(ModestcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid modestcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid modestcoin address" in e.error['message'])
