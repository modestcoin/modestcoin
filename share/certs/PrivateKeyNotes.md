...
unlocked to sign the Modestcoin-Qt.app bundle.
...
allowing somebody to distribute a Modestcoin-Qt.app or modestcoin-qt-setup.exe with a valid
...
that the modestcoin-qt.exe file inside the installer had not been tampered with.
