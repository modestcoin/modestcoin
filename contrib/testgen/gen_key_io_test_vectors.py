...
bech32_templates = [
  ...
  ('mtc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('mtc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('mtc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tmtc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tmtc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tmtc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rmtc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rmtc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rmtc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tmtc',  17, 32, False, False, False),
  ('rmtc',  3,  1, False, False, False),
  ('mtc',   15, 41, False, False, False),
  ('tmtc',  0, 16, False, False, False),
  ('rmtc',  0, 32, True,  False, False),
  ('mtc',   0, 16, True,  False, False),
  ('tmtc',  0, 32, False, True,  False),
  ('rmtc',  0, 20, False, False, True)
]
