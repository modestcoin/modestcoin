...
LITECOIND=${LITECOIND:-$SRCDIR/modestcoind}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/modestcoin-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/modestcoin-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/modestcoin-qt}
